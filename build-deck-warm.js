/**
 * wuzu tokki / 우주토끼 — IP 소개서 (웜 아이보리 대안본)
 *
 * 확정본은 build-deck.js. 이 버전은 따뜻한 아이보리 + 브론즈 포인트로,
 * 비교용으로 남겨둔다. `node build-deck-warm.js` 로 재생성.
 */
...
const OUT = path.join(__dirname, "Wuzu_Tokki_IP_소개서_웜아이보리_20260922.pptx");
